...
<section class="paper-section" id="analysis">
  ...
  <div class="insight-box" style="border-left-color:var(--accent2);background:rgba(34,211,238,0.06)">
    <strong>维护说明：</strong>正文表格与链接（含 pdf/docs/GitHub）同步自上游仓库
...
<head>
  ...
  <meta name="description" content="Streaming-Video-Understanding：连续视频流 VLM/MLLM 论文、PDF、代码与评测资源，镜像自 Awesome-VLM-Streaming-Video，附中文综合评析。" />
...
<body>
  <header>
    <div class="logo-row">
      ...
      <span class="org-badge"><span>📅</span><span>README 同步：2026-05（upstream main）</span></span>
    </div>
